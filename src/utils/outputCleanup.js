...
const STATE_TAG_RE = /\[\[\s*(?:MONEY|REL|BODY|SHOP|LOOT|POKECENTER|NPC|FACT|POKEMON|EVOLVE|EVOLUTION|LEVEL|LV|FRIEND|FRIENDSHIP|ITEM|EQUIP|UNEQUIP|TRAIN|HUNGER|DATE|MOVE|BADGE|QUEST|REP|WANTED|RIBBON|MARK|LEGENDARY_ACCESS|BATTLE)[^\]]*\]\]/gi
